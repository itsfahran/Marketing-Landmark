...
-- 5. HIRE GIGS TABLE
CREATE TABLE IF NOT EXISTS hire_gigs (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  title TEXT NOT NULL,
  image_url TEXT,
  rating DECIMAL(3,1),
...
-- 8. CHOOSE FEATURES TABLE
CREATE TABLE IF NOT EXISTS choose_features (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  title TEXT NOT NULL,
  description TEXT,
  icon_name TEXT,
...
-- 9. HOME PORTFOLIO ITEMS TABLE
CREATE TABLE IF NOT EXISTS home_portfolio_items (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  title TEXT NOT NULL,
  description TEXT,
  category TEXT,
...
-- 12. ABOUT PAGE MARQUEE TABLE
CREATE TABLE IF NOT EXISTS about_page_marquee (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  text TEXT NOT NULL,
  sort_order INTEGER DEFAULT 0,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
-- 13. ABOUT PAGE MISSION/VALUES TABLE
CREATE TABLE IF NOT EXISTS about_page_mission_values (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  type TEXT NOT NULL,
  icon_url TEXT,
  title TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS about_page_team (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  name TEXT NOT NULL,
  role TEXT NOT NULL,
  image_url TEXT,
...
-- 15. ABOUT PAGE ACHIEVEMENTS TABLE
CREATE TABLE IF NOT EXISTS about_page_achievements (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  icon TEXT,
  value TEXT NOT NULL,
  label TEXT NOT NULL,
...
-- 7. BRANDS (Home) - THIS WAS MISSING!
DELETE FROM brands;
