...
-- Run this in Supabase SQL Editor to populate all page data
-- ============================================
...
-- ============================================
-- SELECT COUNT(*) as total_records, 'hero' as table_name FROM hero
-- UNION ALL SELECT COUNT(*), 'services' FROM services
-- UNION ALL SELECT COUNT(*), 'hire_gigs' FROM hire_gigs
-- UNION ALL SELECT COUNT(*), 'process_steps' FROM process_steps
-- UNION ALL SELECT COUNT(*), 'home_testimonials' FROM home_testimonials
-- UNION ALL SELECT COUNT(*), 'brands' FROM brands
-- UNION ALL SELECT COUNT(*), 'choose_features' FROM choose_features
-- UNION ALL SELECT COUNT(*), 'about_page_team' FROM about_page_team
-- UNION ALL SELECT COUNT(*), 'about_page_achievements' FROM about_page_achievements;
